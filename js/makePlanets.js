...
function generatePlanets() {
  ...
  var saturn_desc = "is the sixth planet from the Sun and the most distant that can be seen with the naked eye.";
  ...
  //Create Planets
  createPlanet("Mercury", mercury_desc, 0.5, "rgb(128,128,128)", 20.81, 4);
  createPlanet("Venus", venus_desc, 2, "rgb(255,255,224)", 38.83, 3.5);
  createPlanet("Earth", earth_desc, 2, "rgb(0,119,190)", 53.72, 3);
  createPlanet("Mars", mars_desc, 1, "rgb(255,99,71)", 81.84, 2.5);
  createPlanet("Jupiter", jupiter_desc, 5, "rgb(244,164,96)", 279.52, 2);
  createPlanet("Saturn", saturn_desc, 4, "rgb(255,222,173)", 512.6, 1.5);
  createPlanet("Uranus", uranus_desc, 3, "rgb(135,206,250)", 631.07, 1);
  createPlanet("Neptune", neptune_desc, 4, "rgb(65,105,225)", 700, 0.5);
  ...
  //Create Moons
  createMoon("Moon", moon_desc, 0.25, "rgb(220,220,220)", 10, 8, "Earth");
}
