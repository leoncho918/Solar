...
function generatePlanets() {
  ...
  createStar("Sun", sun_desc, "Yellow Dwarf", 10, "rgb(255, 230, 100)", 1);
  ...
  //Create Planets
  createPlanet("Mercury", mercury_desc, "Terrestrial Planet", 0.5, "rgb(128,128,128)", 20.81, 4);
  createPlanet("Venus", venus_desc, "Terrestrial Planet", 2, "rgb(255,255,224)", 38.83, 3.5);
  createPlanet("Earth", earth_desc, "Terrestrial Planet", 2, "rgb(0,119,190)", 53.72, 3);
  createPlanet("Mars", mars_desc, "Terrestrial Planet", 1, "rgb(255,99,71)", 81.84, 2.5);
  createPlanet("Jupiter", jupiter_desc, "Gas Giant", 5, "rgb(244,164,96)", 279.52, 2);
  createPlanet("Saturn", saturn_desc, "Gas Giant", 4, "rgb(255,222,173)", 512.6, 1.5);
  createPlanet("Uranus", uranus_desc, "Gas Giant", 3, "rgb(135,206,250)", 631.07, 1);
  createPlanet("Neptune", neptune_desc, "Gas Giant", 4, "rgb(65,105,225)", 700, 0.5);
  ...
  //Create Moons
  createMoon("Moon", moon_desc, "Natural Satellite", 0.25, "rgb(220,220,220)", 10, 8, "Earth");
}
